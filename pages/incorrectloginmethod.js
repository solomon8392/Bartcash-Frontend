...
export default function Home() {
    return(
        <div className={`flex flex-col items-center justify-center h-screen`}>
            ...
            <div className={`pt-10 font-bold text-[20px] md:text-[25px]`}>Incorrect Signin Method</div>
            <div className={`pt-10 font-bold text-[14px] md:text-[18px]`}>You are probably signud up with email and password but you are trying to login with a different method.</div>
        </div>
    );
}