...
export default function Home() {
    return(
        <div className={`flex flex-col items-center justify-center h-screen`}>
            ...
            <FontAwesomeIcon icon={faMessage} className={`text-[80px] md:text-[120px]`} />
            </div>
            <div className={`pt-10 font-bold text-[20px] md:text-[25px]`}>Verification Email Sent</div>
            <div className={`pt-10 font-bold text-[14px] md:text-[218px]`}>Kindly check your email.</div>
        </div>
    );
}