...
export default function Home() {
  ...
  const Bids = [
    [
      {
        key: uuidv4(),
        bidName: "Authentication and verification of products",
        innertext:
    ...
    [
      {
        key: uuidv4(),
        bidName: "Lorem ipsum,lorem ipsum",
        innertext:
          "Exercitation in fugiat est ut ad ea cupidatat ut in cupidatat occaecat ut occaecat consequat est minim minim esse tempor laborum consequat esse adipisicing eu reprehenderit enim Exercitation in fugiat est ut ad ea cupidatat ut in cupidatat occaecat ut occaecat consequat est minim minim esse tempor laborum consequat esse adipisicing eu reprehenderit enim.",
      },
      {
        key: uuidv4(),
        bidName: "Lorem ipsum dolor amet",
        innertext:
          "Exercitation in fugiat est ut ad ea cupidatat ut in cupidatat occaecat ut occaecat consequat est minim minim esse tempor laborum consequat esse adipisicing eu reprehenderit enim Exercitation in fugiat est ut ad ea cupidatat ut in cupidatat occaecat ut occaecat consequat est minim minim esse tempor laborum consequat esse adipisicing eu reprehenderit enim.",
      },
    ],
  ...
  const biditems = Bids.map((items, index) => (
    <div className="my-[20px] justify-between" key={`${items[0].key}-parent`}>
  ...
  const [_, _setBidIndex] = useState(0);
  const [currentBid, setCurrentBid] = useState(Bids[0]);

  const setBidIndex = (index) => {
    console.log(`Bid inxex is: `, index);

    _setBidIndex(index);
    setCurrentBid(Bids[index]);
  };
  ...
  return (
    <div>
      ...
      <div className="bg-[#001D3D] justify-center h-[120%] flex items-center h-[61vh] lg:h-[67vh] md:h-[67vh]">
      ...
      <div>
        {currentBid.map((bid, _index) => (
          <div className="my-[20px] justify-between" key={bid.key}>
            <div className="w-[100%]  cursor-pointer flex rounded-md justify-center text-center items-center">
              <div
