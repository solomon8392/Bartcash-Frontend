  ...
  const [hide, setHide] = useState(true);
    ...
    return (
        <div className={`w-full flex px-6 gap-4 xl:gap-10 relative items-center justify-between py-2`}>
          ...
          <div className="flex justify-center absolute left-[50%] translate-x-[-50%] w-fit">
            <div className="xl:w-[600px] hidden md:block">
              <div className="input-group relative flex w-full">
                <input type="search" className="form-control relative flex-auto block px-3 py-1.5 text-base font-normal bg-gray-200 text-gray-700 bg-clip-padding border border-solid border-gray-300 rounded transition ease-in-out m-0 focus:text-gray-700 focus:bg-gray-100 focus:outline-none" placeholder="Search for product, category" />
